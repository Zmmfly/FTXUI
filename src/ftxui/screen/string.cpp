...
// Generated from the Unicode 16.0.0 East_Asian_Width=Ambiguous property.
// GNU Screen enables its equivalent table automatically for CJK locales,
// while many outer terminal emulators keep these codepoints narrow.
constexpr std::array<Interval, 179> g_ambiguous_width_characters = {{
...
bool IsAmbiguousWidth(uint32_t ucs) {
